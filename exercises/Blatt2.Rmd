...
Bitte laden Sie den Datensatz *ergometer.RData* mittels *load()*. Die Beschreibung der Variablen finden Sie in Tabellen \@ref(tab:B2A1-1).
...
Bitte laden Sie den Datensatz *haendigkeit.RData* mittels *load()*. Die Beschreibung der Variablen finden Sie in Tabellen \@ref(tab:B2A2-1).
